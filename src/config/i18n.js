...
export const contact = [
    {
        ...
        en: [
                {
                    title: 'Contact Me',
                    description: 'I am available for freelance work. If you have a project that you want to get started, think you need my help with something or just fancy saying hello, then get in touch.',
                    image: '',
                    phone: '06 00 00 00 00',
                    email: 'monEmail@mail.fr',
                    address: '1 rue de Paris',
